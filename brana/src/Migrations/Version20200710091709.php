 ...
 */
final class Version20200710091709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE things (user_rel INT NOT NULL, last_update_when DATE DEFAULT NULL, status VARCHAR(128) DEFAULT NULL, id INT AUTO_INCREMENT NOT NULL, username VARCHAR(256) DEFAULT \'unknown\' NOT NULL, name VARCHAR(256) DEFAULT NULL, password VARCHAR(256) DEFAULT NULL, email VARCHAR(256) DEFAULT NULL, from_date DATE DEFAULT NULL, is_admin TINYINT(1) DEFAULT NULL, type INT DEFAULT NULL, UNIQUE INDEX UNIQ_6FE451BDBF396750 (id), INDEX IDX_6FE451BD1FACB636 (user_rel)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
